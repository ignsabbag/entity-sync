...
import com.entitysync.data.Order;
...
public class SyncComparatorTest {
    ...
    public void testComparator() {
        List<Class<?>> unsorted = Arrays.asList(Order.class, Brand.class, Product.class);
        List<Class<?>> sorted = Arrays.asList(Brand.class, Product.class, Order.class);
