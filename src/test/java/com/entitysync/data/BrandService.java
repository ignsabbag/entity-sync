...
public class BrandService {
    ...
    private final JpaEntityVersionRepository entityVersionRepository;

    @Autowired
    public BrandService(BrandRepository brandRepository, JpaEntityVersionRepository entityVersionRepository) {
